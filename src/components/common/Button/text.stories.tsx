...
export const primaryDisabled = () => <Button onClick={onClickBtn} disabled={true}>Halda áfram</Button>

export const secondary = () => <Button onClick={onClickBtn} variant="secondary">Halda áfram</Button>

export const secondaryDisabled = () => <Button onClick={onClickBtn} variant="secondary" disabled={true}>Halda áfram</Button>
